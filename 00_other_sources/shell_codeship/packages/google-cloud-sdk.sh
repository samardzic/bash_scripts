...
echo -e -e "\e[0;33mCodeship Basic now includes the gcloud CLI by default.\e[0m"
echo -e -e "\e[0;33mPlease see https://documentation.codeship.com/basic/continuous-deployment/deployment-with-gcloudcli and\e[0m"
echo -e -e "\e[0;33mhttps://documentation.codeship.com/basic/continuous-deployment/deployment-to-google-app-engine for more information.\e[0m"
...
if [[ -z ${GOOGLE_CLOUD_KEY} || -z ${GOOGLE_CLOUD_PROJECT_ID} ]]; then
  echo -e -e "\e[0;33mWarning: Please make sure GOOGLE_CLOUD_KEY and GOOGLE_CLOUD_PROJECT_ID are set.\e[0m"
else
  echo -e "${GOOGLE_CLOUD_KEY}" > "${GOOGLE_CLOUD_KEYFILE}"
