...
if [ -z ${GIT_LFS_VERSION} ]; then
	echo -e -e "\e[0;33mWarning: You are relying on the default version of Git LFS.\e[0m"
	echo -e -e "\e[0;33mWe will update this script to switch to version 2.0.0 in the near future, which will break support for the legacy API v0.5.0. Please either specify the GIT_LFS_VERSION environment variable or update your Git LFS server.\e[0m"
	echo -e -e "\e[0;33mPlease see https://github.com/git-lfs/git-lfs/releases/tag/v2.0.0 for more information.\e[0m"
fi
