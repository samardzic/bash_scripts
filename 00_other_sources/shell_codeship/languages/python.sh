...
echo -e -e "\e[0;33mCodeship Basic now uses pyenv for Python support by default.\e[0m"
echo -e -e "\e[0;33mThis script is no longer required for installing custom Python versions.\e[0m"
echo -e -e "\e[0;33mPlease see https://blog.codeship.com/improved-python-version-management-and-caching-on-codeship-basic for more information.\e[0m"
