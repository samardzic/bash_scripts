...
function message1hr() {
	...
	TEXT_ACTIONBAR=bold+"\u540c\u968a\u8a0e\u8ad6\u8acb\u5229\u7528RC\u804a\u5929\u5ba4:"+blue+bold+"27685743"
	TEXT_TITLE=aqua+bold+italian+"UHC\u7df4\u7fd2\u5834\u6bd4\u8cfd\u898f\u5247"
...
function end_message() {
	...
	switch(end_message_steps) {
		case 0:
			actionbar(TEXT_ACTIONBAR)
			title(aqua+bold+italian+"UHC\u03b8\u76c3\u5df2\u7d93\u7d50\u675f...")
			break;
		case 1:
			actionbar(TEXT_ACTIONBAR)
			title(aqua+bold+italian+"UHC\u4f3a\u670d\u5668\u5373\u5c07\u95dc\u9589...")
			// break;
		default:
			end_message_steps=0
			return true
...
function ending() {
	...
	switch(ending_step) {
		...
		case 1:
		case 2:
			// subtitle(bold+"留下來看排行榜 或是全員離線遊戲重置")
			subtitle(bold+"\u7559\u4e0b\u4f86\u770b\u6392\u884c\u699c \u6216\u662f\u5168\u54e1\u96e2\u7dda\u904a\u6232\u91cd\u7f6e")
