...
GIT_LOCATION=~/auth-java

#Sources Local config file neme and location for local variables
LOCAL_CONF_PATH=~/Config_files/auth_java_conf.env

#Docker config file neme and location for docker variables
DOCKER_CONF_PATH=~/Config_files/auth_java_docker_conf.env
...
#docker run --env-file=~/Config_files/auth_java_docker_conf.env --net=host -p 8081:$8081 -d --name auth-java auth-java
